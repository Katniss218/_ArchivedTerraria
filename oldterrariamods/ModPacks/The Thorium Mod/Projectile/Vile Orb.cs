public void AI()
{
												if (projectile.type == Config.projDefs.byName["Breath"].type)
												{
													int num44 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 64, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100, default(Color), 3.5f);
												...
												else
												{
													if (projectile.type == 79)
													{
														...
														{
															int num46 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 64, 0f, 0f, 100, new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB), 2.5f);
													...
													else
													{
														...
														int num47 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 64, 0f, 0f, 100, default(Color), 2f);
												...
												if (projectile.type == Config.projDefs.byName["Vile Orb"].type)
												{
