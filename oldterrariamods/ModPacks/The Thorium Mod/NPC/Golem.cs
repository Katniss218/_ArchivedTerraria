public void NPCLoot()
{
     	Gore.NewGore(npc.position,npc.velocity,"Golem Head",1f,-1);
	Gore.NewGore(npc.position,npc.velocity,"Golem Arm",1f,-1);
	Gore.NewGore(npc.position,npc.velocity,"Golem Arm",1f,-1);
	Gore.NewGore(npc.position,npc.velocity,"Golem Leg",1f,-1);
	Gore.NewGore(npc.position,npc.velocity,"Golem Leg",1f,-1);
}
