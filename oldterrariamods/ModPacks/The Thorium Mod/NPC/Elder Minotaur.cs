...
public void NPCLoot()
{
     	Gore.NewGore(npc.position,npc.velocity,"Min Head",1f,-1);
	Gore.NewGore(npc.position,npc.velocity,"Min Arm",1f,-1);
	Gore.NewGore(npc.position,npc.velocity,"Min Arm",1f,-1);
	Gore.NewGore(npc.position,npc.velocity,"Min Leg",1f,-1);
	Gore.NewGore(npc.position,npc.velocity,"Min Leg",1f,-1);
	Gore.NewGore(npc.position,npc.velocity,"Min Body",1f,-1);
}