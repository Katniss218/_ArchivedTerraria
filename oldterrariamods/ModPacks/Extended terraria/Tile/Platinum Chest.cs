...
public void MouseOverTile(int x,int y, Player player) {
	...
	player.showItemIcon2 = Config.itemDefs.byName["Platinum Chest"].type;
}
...
public void MouseOverTile(int x,int y,Player P)
{
	P.noThrow = 2;
	P.showItemIcon = true;
	P.showItemIcon2 = Config.itemDefs.byName["Platinum Chest"].type;
}*/