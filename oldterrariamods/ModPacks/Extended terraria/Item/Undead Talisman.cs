...
public void DamagePlayer(Player P,ref int DMG,NPC N)
{
    if(P.immune) return;
    int NT = N.type;
    if(NT == 3 || NT == 21 || NT == 31 || NT == 32 || NT == 33 || NT == 34 || NT == 44 || NT == 45 || NT == 52 || NT == 53 || NT == 77 || NT == 78 || NT == 79 || NT == 80 || NT == 82 || NT == 109 || NT == 110 || NT == 132 || NT == 140 || NT == Config.npcDefs.byName["Magma Skeleton"].type || NT == Config.npcDefs.byName["Troll"].type || NT == Config.npcDefs.byName["Heavy Zombie"].type || NT == Config.npcDefs.byName["Ice Skeleton"].type || NT == Config.npcDefs.byName["Irate Bones"].type || NT == Config.npcDefs.byName["Cursed Skull 2"].type)
    {
