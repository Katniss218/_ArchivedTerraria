public bool SpawnNPC(int x, int y, int playerID)
{
	...
	{
		if (CanSpawnHere && !Main.player[playerID].zoneDungeon && Main.rand.Next(12) == 0)
		{
			return true;
		}
		else return false;
...
public void DamagePlayer(Player player, ref int damage)
{
	...
	{
		player.AddBuff(39, 420, false);
	}
}
public void NPCLoot()
{
	Gore.NewGore(npc.position,npc.velocity,"Cursed Skeleton Helmet",1.1f,-1);
