...
public void AI()
{
								...
								{
									if (npc.type == Config.npcDefs.byName["Armored Hell Corruptor 2"].type)
									{
										num73 = 4.2f;
										num74 = 0.022f;
									}
								...
								if (npc.type == 6 || npc.type == 42 || npc.type == Config.npcDefs.byName["Armored Hell Corruptor 2"].type || npc.type == 139)
								{
									if (num78 > 100f || npc.type == 42 || npc.type == Config.npcDefs.byName["Armored Hell Corruptor 2"].type)
									{
										npc.ai[0] += 1f;
										if (npc.ai[0] > 0f)
										{
									...
									if (num78 < 150f && (npc.type == 6 || npc.type == Config.npcDefs.byName["Armored Hell Corruptor 2"].type))
									{
								...
								else
								{
									...
									{
										if (npc.type == 6 || npc.type == Config.npcDefs.byName["Armored Hell Corruptor 2"].type)
										{
								...
								if (npc.type == 6 || npc.type == 23 || npc.type == 42 || npc.type == Config.npcDefs.byName["Armored Hell Corruptor 2"].type || npc.type == 139)
								{
									float num83 = 0.7f;
									if (npc.type == 6)
									{
								...
								if ((npc.type == 6 || npc.type == Config.npcDefs.byName["Armored Hell Corruptor 2"].type) && npc.wet)
								{
								...
								if (Main.netMode != 1 && npc.type == Config.npcDefs.byName["Armored Hell Corruptor 2"].type && !Main.player[npc.target].dead)
								{
									if (npc.justHit)
									{
										npc.localAI[0] = 0f;
								...
								if ((Main.dayTime && npc.type != 6 && npc.type != 23 && npc.type != 42 && npc.type != 94 && npc.type != Config.npcDefs.byName["Armored Hell Corruptor 2"].type) || Main.player[npc.target].dead)
								{
