...
{				
									...
									if (Main.netMode != 1)
									{
										if (this.npc.type == Config.npcDefs.byName["Shadow Dragon Head"].type && npc.ai[0] == 0f)
										{
											...
											{
												int num98 = Config.npcDefs.byName["Shadow Dragon Body"].type;
												if (num97 == 4 || num97 == 9 || num97 == 14 || num97 == 19)
												{
													num98 = Config.npcDefs.byName["Shadow Dragon Legs"].type;
												}
												else
												{
													if (num97 == 21)
													{
														num98 = Config.npcDefs.byName["Shadow Dragon Body 2"].type;
													}
													else
													{
														if (num97 == 22)
														{
															num98 = Config.npcDefs.byName["Shadow Dragon Body 3"].type;
														}
														else
														{
															if (num97 == 23)
															{
																num98 = Config.npcDefs.byName["Shadow Dragon Tail"].type;
															}
														}
													}
												}
									...
									float num118 = Config.syncedRand.Next(-500,500)+Main.player[this.npc.target].position.X + (float)(Main.player[this.npc.target].width / 2);
									float num119 = Config.syncedRand.Next(-500,500)+Main.player[this.npc.target].position.Y + (float)(Main.player[this.npc.target].height / 2);
