...
public void AI()
{
	...
	int dust = Dust.NewDust(new Vector2((float) npc.position.X, (float) npc.position.Y), npc.width, npc.height, 54, Config.syncedRand.Next(-20,20)*2, Config.syncedRand.Next(-20,20)*2, 100, color, 4f);
	...
	int dust = Dust.NewDust(new Vector2((float) npc.position.X, (float) npc.position.Y), npc.width, npc.height, 54, Config.syncedRand.Next(-20,20)*2, Config.syncedRand.Next(-20,20)*2, 100, color, 4f);
	Main.dust[dust].noGravity = true;
	dust = Dust.NewDust(new Vector2((float) npc.position.X, (float) npc.position.Y), npc.width, npc.height, 62, Config.syncedRand.Next(-20,20)*2, Config.syncedRand.Next(-20,20)*2, 100, color, 4f);
	Main.dust[dust].noGravity = true;
	}
	if (npc.ai[2] > 900)
	{
	...
	dust = Dust.NewDust(new Vector2((float) npc.position.X, (float) npc.position.Y), npc.width, npc.height, 62, Config.syncedRand.Next(-20,20)*2, Config.syncedRand.Next(-20,20)*2, 100, color, 4f);
	Main.dust[dust].noGravity = true;
	dust = Dust.NewDust(new Vector2((float) npc.position.X, (float) npc.position.Y), npc.width, npc.height, 54, Config.syncedRand.Next(-20,20)*2, Config.syncedRand.Next(-20,20)*2, 100, color, 4f);
	Main.dust[dust].noGravity = true;
	dust = Dust.NewDust(new Vector2((float) npc.position.X, (float) npc.position.Y), npc.width, npc.height, 62, Config.syncedRand.Next(-20,20)*2, Config.syncedRand.Next(-20,20)*2, 100, color, 4f);
	Main.dust[dust].noGravity = true;
	}
