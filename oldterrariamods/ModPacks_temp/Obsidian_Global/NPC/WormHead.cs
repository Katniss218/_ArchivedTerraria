...
if(timer==0){
//Main.npc[i].StrikeNPC(15,5, this.npc.direction);
timer--;
}
...
if (this.npc.type == 117 && this.npc.localAI[1] == 0f)
									...
									if (Main.netMode != 1)
									{
										...
										if ((this.npc.type == 7 || this.npc.type == 8 || this.npc.type == Config.npcDefs.byName["WormHead"].type  || this.npc.type == Config.npcDefs.byName["WormBody"].type || this.npc.type == 13 || this.npc.type == 14 || this.npc.type == 39 || this.npc.type == 40 || this.npc.type == 95 || this.npc.type == 96 || this.npc.type == 98 || this.npc.type == 99 || this.npc.type == 117 || this.npc.type == 118) && this.npc.ai[0] == 0f)
										{
											if (this.npc.type == 7 || this.npc.type == Config.npcDefs.byName["WormHead"].type || this.npc.type == 13 || this.npc.type == 39 || this.npc.type == 95 || this.npc.type == 98 || this.npc.type == 117)
											{
												if (this.npc.type < 13 || this.npc.type > 15)
												{
												...
												this.npc.ai[2] = (float)Main.rand.Next(4, 9);
									...
									if (!flag11 && (this.npc.type == 7 ||this.npc.type == Config.npcDefs.byName["WormHead"].type || this.npc.type == 13 || this.npc.type == 39 || this.npc.type == 95 || this.npc.type == 98 || this.npc.type == 117))
									{
...
this.npc.position.Y = Main.player[Main.myPlayer].position.Y + 120;
this.npc.velocity.X = 3*Main.player[Main.myPlayer].direction;
