...
if (!Main.dayTime && (surface || underground))
					{
...
float maxspeedX = 3.2f; // default : 1.1f
float accelerationX = 0.1f; //default : 0.07f
float longjumpX = 2f; // default : 1.5f
float longjumpY = 6.5f; // default : 8f
float jumpY = 6.5f; // default : 5f
...
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f),  "Undead Raptor Gore 1", 1f, -1);
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f),  "Raptor Gore 1", 1f, -1);
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f),  "Raptor Gore 2", 1f, -1);
