...
float maxspeedX = 0.7f; // default : 1.1f
float accelerationX = 0.05f; //default : 0.07f
float longjumpX = 1.2f; // default : 1.5f
float longjumpY = 4f; // default : 8f
float jumpY = 4f; // default : 5f
float inertie = 0.2f; //default : 0.8f
...
{
if (npc.life <= 0){
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f),  name+" Gore "+2, 1f, -1);
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f),  name+" Gore "+1, 1f, -1);
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f),  name+" Gore "+1, 1f, -1);
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f),  name+" Gore "+1, 1f, -1);}
}
#endregion
