                            ...
                            if (this.projectile.ai[0] == 0f)
                            {
                                ...
                                if (this.projectile.alpha <= 0)
                                {
                                    ...
                                    if (this.projectile.ai[1] == 0f)
                                    {
                                        ...
                                        this.projectile.position += this.projectile.velocity * 1f; //4 was 1
                                    }
                                    ...
                                    if (this.projectile.type == 7 && Main.myPlayer == this.projectile.owner)
                                    {
                                        ...
                                        if (this.projectile.ai[1] >= 9f) // change for max parts was 13
                                        {
                                            num14 = Config.projDefs.byName["Fire Trail"].type;
                                        }
                                        else
                                            num14 = Config.projDefs.byName["Fire Trails"].type;
                                        #endregion
