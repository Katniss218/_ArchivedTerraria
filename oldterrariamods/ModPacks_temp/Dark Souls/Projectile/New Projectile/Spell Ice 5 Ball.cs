	...
	if (Main.myPlayer == projectile.owner && projectile.ai[0] == 0f)
	{
		...
		else
		{
			if (projectile.ai[0] == 0f)
			{
				...
				if (num63 == 0f)
				{
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height), 0, 5, Config.projectileID["Spell Ice 5 Icicle"], (int) (this.projectile.damage), 3f, projectile.owner);
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*4), projectile.position.Y + (float)(projectile.height*2), 0, 5, Config.projectileID["Spell Ice 5 Icicle"], (int) (this.projectile.damage), 3f, projectile.owner);
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*-2), projectile.position.Y + (float)(projectile.height*2), 0, 5, Config.projectileID["Spell Ice 5 Icicle"], (int) (this.projectile.damage), 3f, projectile.owner);
