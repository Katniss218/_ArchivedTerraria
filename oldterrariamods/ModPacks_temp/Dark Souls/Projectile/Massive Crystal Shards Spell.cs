...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
		...
		{
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height), 0, 5, Config.projectileID["Massive Crystal Shards"], (int) (this.projectile.damage), 3f, projectile.owner);
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*5), projectile.position.Y + (float)(projectile.height*4), 0, 5, Config.projectileID["Massive Crystal Shards"], (int) (this.projectile.damage), 3f, projectile.owner);
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*-3), projectile.position.Y + (float)(projectile.height*7), 0, 5, Config.projectileID["Massive Crystal Shards"], (int) (this.projectile.damage), 3f, projectile.owner);
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height*10), 0, 5, Config.projectileID["Massive Crystal Shards"], (int) (this.projectile.damage), 3f, projectile.owner);				
			...
			num41 = Dust.NewDust(arg_1422_0, arg_1422_1, arg_1422_2, arg_1422_3, arg_1422_4, arg_1422_5, arg_1422_6, newColor, 3f);
		}
	}
