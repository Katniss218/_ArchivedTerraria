...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
		...
		{
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width / 2), projectile.position.Y + (float)(projectile.height / 2), 0, 0, Config.projectileID["Enemy Spell Lightning 4 Bolt 1"], 100, 8f, projectile.owner);
