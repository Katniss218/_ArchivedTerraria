...
public void Kill()
{
    ...
    projectile.timeLeft = 0;
    {
        ...
        {
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width / 2), projectile.position.Y + (float)(projectile.height - 16), 3, 0, Config.projectileID["Enemy Enemy Spell Fire 4 Flame 1"], 135, 3f, projectile.owner);
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width / 2), projectile.position.Y + (float)(projectile.height - 16), -3, 0, Config.projectileID["Enemy Spell Fire 4 Flame 2"], 135, 3f, projectile.owner);
