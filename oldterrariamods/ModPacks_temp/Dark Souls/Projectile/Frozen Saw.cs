...
Rectangle prec = new Rectangle((int)Main.player[Main.myPlayer].position.X, (int)Main.player[Main.myPlayer].position.Y, (int)Main.player[Main.myPlayer].width,(int)Main.player[Main.myPlayer].height);
	...
	{
		Main.player[Main.myPlayer].AddBuff(36, 300, false); //broken armor
	}

	if (projrec.Intersects(prec) && Main.rand.Next(10)==0)
	{
		Main.player[Main.myPlayer].AddBuff(35, 180, false); //silenced
		Main.player[Main.myPlayer].AddBuff(32, 300, false); //slow
	}
