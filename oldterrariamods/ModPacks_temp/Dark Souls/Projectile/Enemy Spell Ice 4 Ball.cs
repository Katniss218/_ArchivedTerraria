...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
		...
		{
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height), 0, 5, Config.projectileID["Enemy Spell Ice 4 Icicle"], 100, 3f, projectile.owner);
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*5), projectile.position.Y + (float)(projectile.height*4), 0, 5, Config.projectileID["Enemy Spell Ice 4 Icicle"], 100, 3f, projectile.owner);
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*-3), projectile.position.Y + (float)(projectile.height*7), 0, 5, Config.projectileID["Enemy Spell Ice 4 Icicle"], 100, 3f, projectile.owner);
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height*10), 0, 5, Config.projectileID["Enemy Spell Ice 4 Icicle"], 100, 3f, projectile.owner);				
