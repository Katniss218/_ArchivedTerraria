	...
	if (Main.myPlayer == projectile.owner && projectile.ai[0] == 0f)
	{
		...
		else
		{
			if (projectile.ai[0] == 0f)
			{
				...
				if (num63 == 0f)
				{
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height), 0, 5, Config.projectileID["Spell Ice 4 Icicle"], (int) (this.projectile.damage), 3f, projectile.owner);
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*5), projectile.position.Y + (float)(projectile.height*4), 0, 5, Config.projectileID["Spell Ice 4 Icicle"], (int) (this.projectile.damage), 3f, projectile.owner);
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*-3), projectile.position.Y + (float)(projectile.height*7), 0, 5, Config.projectileID["Spell Ice 4 Icicle"], (int) (this.projectile.damage), 3f, projectile.owner);
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height*10), 0, 5, Config.projectileID["Spell Ice 4 Icicle"], (int) (this.projectile.damage), 3f, projectile.owner);
