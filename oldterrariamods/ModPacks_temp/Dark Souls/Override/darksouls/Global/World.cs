...
#region Can't Put Souls in Chests
 public static void PostDraw(SpriteBatch SP) 
{
   Item I = Main.mouseItem;
   if(I == null) return;
   if(I.stack < 1 || I.type < 1) return;
   if(I.type != Config.itemDefs.byName["Dark Soul"].type) return;
