...
public bool SpawnNPC(int x,int y,int PID)
{
	...
	if(ModWorld.superHardmode && BeforeFourAfterSix && Main.bloodMoon && AboveEarth && Main.rand.Next(2000)==1) 
	...
	if(ModWorld.superHardmode && Main.bloodMoon && Dungeon && !Corruption && InGrayLayer && Main.rand.Next(1000)==1) 
	...
	if(ModWorld.superHardmode && Main.bloodMoon && BeforeFourAfterSix && InHell && Main.rand.Next(700)==1) 
