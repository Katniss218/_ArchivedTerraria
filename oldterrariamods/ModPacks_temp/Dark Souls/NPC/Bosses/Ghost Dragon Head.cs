...
{				
									...
									if (Main.netMode != 1)
									{
										if (this.npc.type == Config.npcDefs.byName["Ghost Dragon Head"].type && npc.ai[0] == 0f)
										{
											...
											{
												int num98 = Config.npcDefs.byName["Ghost Dragon Body"].type;
												if (num97 == 4 || num97 == 9 || num97 == 14 || num97 == 19)
												{
													num98 = Config.npcDefs.byName["Ghost Dragon Legs"].type;
												}
												else
												{
													if (num97 == 21)
													{
														num98 = Config.npcDefs.byName["Ghost Dragon Body 2"].type;
													}
													else
													{
														if (num97 == 22)
														{
															num98 = Config.npcDefs.byName["Ghost Dragon Body 3"].type;
														}
														else
														{
															if (num97 == 23)
															{
																num98 = Config.npcDefs.byName["Ghost Dragon Tail"].type;
															}
														}
													}
												}
