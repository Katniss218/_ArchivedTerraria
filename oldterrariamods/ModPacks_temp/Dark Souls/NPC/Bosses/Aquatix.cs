...
public void AI()
{
	...
	if (npc.ai[1] >= 0 && npc.ai[2] > 120 && npc.ai[2] < 600) //300 was 600
	{
		float num48 = 13f; //
		int damage = 37;
	...
	else if (npc.ai[2] >= 600 && npc.ai[2] < 1200) //300 was 600
	{
	...
	{
	npc.ai[3] = 1;
	npc.life += 50; //50 was 250, amount boss heals when going invisible
