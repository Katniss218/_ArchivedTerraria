...
{				
									...
									if (Main.netMode != 1)
									{
										if (this.npc.type == Config.npcDefs.byName["Jungle Wyvern Head"].type && npc.ai[0] == 0f)
										{
											...
											{
												int num98 = Config.npcDefs.byName["Jungle Wyvern Body"].type;
												if (num97 == 4 || num97 == 9 || num97 == 14 || num97 == 19)
												{
													num98 = Config.npcDefs.byName["Jungle Wyvern Legs"].type;
												}
												else
												{
													if (num97 == 21)
													{
														num98 = Config.npcDefs.byName["Jungle Wyvern Body 2"].type;
													}
													else
													{
														if (num97 == 22)
														{
															num98 = Config.npcDefs.byName["Jungle Wyvern Body 3"].type;
														}
														else
														{
															if (num97 == 23)
															{
																num98 = Config.npcDefs.byName["Jungle Wyvern Tail"].type;
															}
														}
													}
												}
									...
									float num120 = (float)Math.Sqrt((double)(num118 * num118 + num119 * num119));
										...
										if (this.npc.position.Y > Main.player[this.npc.target].position.Y || (double)(Main.player[this.npc.target].position.Y / 16f) < Main.rockLayer || Main.player[this.npc.target].dead)
										{
											flag14 = true;
