...
public bool SpawnNPC(int x,int y,int PID)
{
	...
	if(Main.hardMode && !ModWorld.superHardmode && Main.bloodMoon && AboveEarth && Main.rand.Next(15000)==1) 
	...
	if(Main.hardMode && !ModWorld.superHardmode && Main.bloodMoon && Dungeon && !Corruption && InGrayLayer && Main.rand.Next(3000)==1) 
	...
	if(Main.hardMode && !ModWorld.superHardmode && Main.bloodMoon && InHell && Main.rand.Next(700)==1) 
