...
if (Main.rand.Next(15)==0) //1 in 25 chance boss will summon an NPC
				...
				if (Random == 50) Paraspawn = NPC.NewNPC((int) Main.player[this.npc.target].position.X+50-this.npc.width/2, (int) Main.player[this.npc.target].position.Y-50-this.npc.width/2, "Illuminant Bat", 0);
