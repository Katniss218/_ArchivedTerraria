...
public static bool SpawnNPC(int x, int y, int playerID) {
    ...
    {
	    if (Main.player[playerID].position.Y > ((Main.rockLayer * 15.0)) && Main.player[playerID].position.X < ((Main.rockLayer * 60.0)) && Main.rand.Next(2000)==1) return true;
	    if (Main.player[playerID].position.Y > ((Main.rockLayer * 15.0)) && Main.player[playerID].position.X > ((Main.rockLayer * 145.0)) && Main.rand.Next(2000)==1) return true;
        return false;
    }
return false;
}
