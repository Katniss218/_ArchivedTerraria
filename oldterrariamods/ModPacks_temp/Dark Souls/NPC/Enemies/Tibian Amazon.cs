...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    {
	    if (!Main.player[playerID].zoneEvil && Main.rand.Next(40)==1) return true;

		if(!Main.player[playerID].zoneEvil && !Main.dayTime && Main.rand.Next(25)==1) return true;

		if(Main.player[playerID].zoneEvil && !Main.hardMode && Main.rand.Next(30)==1) return true;

		if(Main.player[playerID].zoneEvil && !Main.hardMode && !Main.dayTime && Main.rand.Next(20)==1) return true;
...
public void NPCLoot()
{
    if (npc.life <= 0)
    {
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Amazon Gore 1", 1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Amazon Gore 2", 1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Amazon Gore 3", 1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Amazon Gore 2", 1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Amazon Gore 3", 1f, -1);
    }
}
