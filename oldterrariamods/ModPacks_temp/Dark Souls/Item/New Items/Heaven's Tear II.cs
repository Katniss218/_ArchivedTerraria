...
public void DamageNPC(Player myPlayer,NPC npc, ref int damage, ref float knockback)
{
	...
	else if (npc.name=="Barrow Wight Nemesis") damage *= 2;
	else if (npc.name=="Oolacile Sorcerer") damage *= 2;
	else if (npc.name=="Abysmal Oolacile Sorcerer") damage *= 2;
	else if (npc.name=="Dark Cloud") damage *= 2;
