public Color ToPass = Color.White;
...
{
        Armor = Shirt; //makes the armor have the color of the shirt
}

public void DrawAfterArms(Player P,SpriteBatch SP,ref bool LetDraw,ref Color Skin,ref Color Undershirt,ref Color Shirt,ref Color Armor)
{
        EasyDraw(P,SP,"RC Tibian Female Mage Arms Secondary",2,0,0,0,0,ToPass,true);
}
