...
{
        EasyDraw(P,SP,"Bare Arm",1,0,0,0,0,Skin,true);
        Armor = Shirt; //makes the armor have the color of the shirt
        EasyDraw(P,SP,"RC Tibian Female Archer Arrows",1,0,0,0,0,Color.White,true);
        EasyDraw(P,SP,"RC Tibian Female Archer Skirt",1,0,0,0,0,Undershirt,true);
}
