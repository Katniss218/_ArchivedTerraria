...
{
        Grieves = ToPass; //makes the armor have the color of the shirt
        EasyDraw(P,SP,"RC Tibian Female Mage Bottoms Secondary",1,0,0,0,0,Legs,true);
        EasyDraw(P,SP,"RC Tibian Female Mage Shoes",2,0,0,0,0,Shoes,true);
}
