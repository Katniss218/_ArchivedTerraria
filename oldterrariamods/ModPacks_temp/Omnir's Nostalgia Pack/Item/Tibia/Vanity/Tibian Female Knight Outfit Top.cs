public void DrawBeforeBody(Player P,SpriteBatch SP,ref bool LetDraw,ref Color Skin,ref Color Undershirt,ref Color Shirt,ref Color Armor)
{
        ...
        EasyDraw(P,SP,"RC Tibian Female Knight Skirt",2,0,0,0,0,Undershirt,true);
}
...
{
        EasyDraw(P,SP,"Bare Arm",2,0,0,0,0,Skin,true);
        EasyDraw(P,SP,"RC Tibian Female Knight Outfit Top Arms",2,0,0,0,0,Shirt,true);
}
