public void DrawAfterHead(Player P,SpriteBatch SP,ref Color Skin,ref Color EyeWhite,ref Color Eye,ref Color Hair,ref Color Helm, ref Color Shoes) 
{
    EasyDraw(P,SP,"Black Mage Hat Outfit Head Secondary",1,0,0,0,0,Helm,true);
    Helm=Shoes;
}
