...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    {
        if (Main.player[playerID].townNPCs <= 0f && x > Main.maxTilesX * 0.65f && Main.rand.Next(2)==1) return true;
        else if (Main.bloodMoon && x > Main.maxTilesX * 0.65f && Main.rand.Next(2)==1) return true;
        return false;
    }
    return false;
}
