...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    {
	    if ((x < Main.maxTilesX*0.2f || x > Main.maxTilesX*0.8f) && Main.rand.Next(35)==1) return true;
        if (Main.tile[x,y-1].liquid > 50 && Main.rand.Next(10)==1) return true;
	    return false;
    }
    if (Main.hardMode && (oSurface || oUnderSurface || oUnderground))
    {
	    if (Main.rand.Next(40)==1) return true;
	    return false;
    }
    return false;
}
...
public void NPCLoot()
{
    if (npc.life <= 0)
    {
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Sahagin Chief Gore 1", 0.9f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Sahagin Chief Gore 2", 0.9f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Sahagin Chief Gore 3", 0.9f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Sahagin Chief Gore 2", 0.9f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Sahagin Chief Gore 3", 0.9f, -1);
    }
}
