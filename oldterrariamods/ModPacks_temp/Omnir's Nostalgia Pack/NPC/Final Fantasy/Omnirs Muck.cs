...
//Spawns in the jungle. Does not spawn in Hardmode or if there are Town NPCs.
...
public static bool SpawnNPC(int x, int y, int playerID) 
{
	...
	if (!Main.hardMode && Main.player[playerID].townNPCs <= 0f && Main.player[playerID].zoneJungle && Main.rand.Next(30)==1) return true;
	return false;
}
#endregion
