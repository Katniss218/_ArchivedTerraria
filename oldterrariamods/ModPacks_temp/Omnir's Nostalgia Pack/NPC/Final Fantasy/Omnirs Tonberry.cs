...
//Spawns just before and into the Underworld in Hardmode. Does not spawn in the Jungle, Dungeons, Meteor, or if there are Town NPCs.
...
public static bool SpawnNPC(int x, int y, int playerID) 
{
	...
	if ((oMagmaCavern || oUnderworld) && Main.rand.Next(40)==1) return true;
    return false;
}
#endregion
