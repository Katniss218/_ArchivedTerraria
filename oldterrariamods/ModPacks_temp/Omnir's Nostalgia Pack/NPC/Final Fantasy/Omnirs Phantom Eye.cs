//Spawns in Hardmode Dungeon and Underworld when there are less than 3 Town NPCs.
...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    if (Main.player[playerID].townNPCs > 3f || !Main.hardMode || Main.player[playerID].zoneJungle || Main.player[playerID].zoneMeteor) return false;
    {   
	    if (oUnderworld || Main.player[playerID].zoneDungeon)
        {
	        if (Main.rand.Next(15)==1) return true;
        	else if (Main.bloodMoon && Main.rand.Next(5)==1) return true;
	        return false;
        }
        return false;
    }
