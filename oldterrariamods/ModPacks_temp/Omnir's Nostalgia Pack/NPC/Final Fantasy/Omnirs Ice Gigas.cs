...
//Spawns in the snow, but only for players with more than 200 health and when there are less than 3 Town NPCs.
...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    if (Main.player[playerID].statLifeMax < 200 ||Main.snowTiles < 50 || Main.player[playerID].townNPCs > 2f) return false;
