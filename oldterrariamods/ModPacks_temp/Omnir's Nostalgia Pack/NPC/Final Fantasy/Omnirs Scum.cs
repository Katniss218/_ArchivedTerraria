...
//Spawns in the Underground. Does not spawn in Hardmode, Dungeons, Jungle, Meteor, or if there are more than 2 Town NPCs.
...
public static bool SpawnNPC(int x, int y, int playerID) 
{
	...
	if ((oUnderground || oCavern) && Main.rand.Next(30)==1) return true;
    return false;
}
#endregion
