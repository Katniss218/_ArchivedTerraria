...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    {
	    if (x < Main.maxTilesX*0.35f && Main.rand.Next(30)==1) return true;
	    else if (oCavern && x < Main.maxTilesX*0.65f && Main.rand.Next(17)==1) return true;	
	    else if (oCavern && Main.rand.Next(50)==1) return true;	
        return false;
    }
    return false;
}
