...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    {
	    if (Main.rand.Next(1000)==1) return true;
	    else if ((x < Main.maxTilesX*0.3f || x > Main.maxTilesX*0.7f) && Main.rand.Next(400)==1) return true;
	    return false;
    }
	if (Main.hardMode && oCavern)
    {
	    if (Main.rand.Next(100)==1) return true;
	    else if ((x < Main.maxTilesX*0.3f || x > Main.maxTilesX*0.7f) && Main.rand.Next(40)==1) return true;
	    return false;
    }
    return false;
}
...
public void NPCLoot()
{
    if (npc.life <= 0)
    {
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Warlock Gore 1", 1.1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Warlock Gore 2", 1.1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Warlock Gore 3", 1.1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Warlock Gore 2", 1.1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Warlock Gore 3", 1.1f, -1);
    }
}
