...
public static bool SpawnNPC(int x, int y, int playerID) 
{
	...
	if (Main.hardMode)
    {
        ...
        {
	        if (Main.player[playerID].townNPCs <= 0f && Main.rand.Next(75)==1) return true;
	        else if (Main.player[playerID].townNPCs <= 0f && (x < Main.maxTilesX*0.2f || x > Main.maxTilesX*0.8f) && Main.rand.Next(5)==1) return true;
	        else if (Main.bloodMoon && Main.rand.Next(55)==1) return true;
	        return false;
        }
        return false;
    }
...
{
if (npc.life <= 0){
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Diabolic Imp Gore 1", 1f, -1);
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Diabolic Imp Gore 2", 1f, -1);
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Diabolic Imp Gore 3", 1f, -1);
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Diabolic Imp Gore 4", 1f, -1);
Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Diabolic Imp Gore 4", 1f, -1);
}
}
#endregion