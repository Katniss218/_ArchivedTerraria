...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    {
	    if (x > Main.maxTilesX*0.57f && Main.rand.Next(5)==1) return true;
	    else if ((oUnderSurface || oUnderground) && x > Main.maxTilesX*0.42f && Main.rand.Next(3)==1) return true;	
	    else if ((oUnderSurface || oUnderground) && Main.rand.Next(15)==1) return true;	
        return false;
    }
    return false;
}
