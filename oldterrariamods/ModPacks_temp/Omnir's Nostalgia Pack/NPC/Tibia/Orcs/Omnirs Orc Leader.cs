...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    {
	    if (x > Main.maxTilesX*0.7f && Main.rand.Next(80)==1) return true;
	    else if ((oUnderSurface || oUnderground) && x > Main.maxTilesX*0.62f && Main.rand.Next(400)==1) return true;	
	    else if ((oUnderSurface || oUnderground) && Main.rand.Next(475)==1) return true;	
        return false;
    }
