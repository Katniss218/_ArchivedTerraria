...
//Spawns on the Surface down into the Underground. Mostly spawns after 4.2/10th (Width). Does not spawn in the Dungeon, Hardmode, Jungle, Meteor, or if there are Town NPCs.
...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    {
	    if (x > Main.maxTilesX*0.65f && Main.rand.Next(15)==1) return true;
	    else if ((oUnderSurface || oUnderground) && x > Main.maxTilesX*0.42f && Main.rand.Next(6)==1) return true;	
