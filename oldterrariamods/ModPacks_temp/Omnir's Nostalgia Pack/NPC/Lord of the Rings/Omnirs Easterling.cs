...
//Spawns on the Surface down to the Underground, near large bodies of water, after 6/10th (Width) on Hardmode. Does not spawn in Dungeons, Meteor, or if there are Town NPCs.
...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    if (Main.player[playerID].townNPCs > 3f || !Main.hardMode || Main.player[playerID].zoneDungeon || Main.player[playerID].zoneMeteor) return false;
