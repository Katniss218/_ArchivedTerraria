...
//Spawns on the Surface down to the Underground, near large bodies of water, before 4/10th (Width). Does not spawn in Hardmode, Dungeons, Meteor, or if there are Town NPCs.
...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    if (Main.tile[x,y-1].liquid < 10 || Main.player[playerID].townNPCs > 0f || Main.hardMode || Main.player[playerID].zoneDungeon || Main.player[playerID].zoneMeteor) return false;
