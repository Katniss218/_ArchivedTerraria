...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    if (Main.hardMode && Main.bloodMoon && !oSky && Main.rand.Next(500)==1) return true;
    if (Main.bloodMoon && !oSky && Main.rand.Next(1500)==1) return true;
    if (oUnderworld)
    {
	    if (Main.player[playerID].townNPCs < 3f)
        {
            if (Main.rand.Next(2000)==1) return true;
	        else if ((x < Main.maxTilesX*0.25f || x > Main.maxTilesX*0.75f) && Main.rand.Next(500)==1) return true;
	        return false;
        }
        if (Main.hardMode && Main.player[playerID].townNPCs < 3f)
        {
            if (Main.rand.Next(75)==1) return true;
	        else if ((x < Main.maxTilesX*0.25f || x > Main.maxTilesX*0.75f) && Main.rand.Next(25)==1) return true;
	        return false;
        }
        return false;
    }
...
public void NPCLoot()
{
    if (npc.life <= 0)
    {
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Ancient Juggernaut Gore 1", 1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Ancient Juggernaut Gore 2", 1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Ancient Juggernaut Gore 3", 1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Ancient Juggernaut Gore 2", 1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Ancient Juggernaut Gore 3", 1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Ancient Juggernaut Gore 3", 1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Ancient Juggernaut Gore 3", 1f, -1);
