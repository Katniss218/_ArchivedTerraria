...
//Spawns in the Underworld when there are no Town NPCs nearby.
...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    if (Main.player[playerID].townNPCs <= 0f && Main.hardMode && oUnderworld && Main.rand.Next(100)==1) return true;
    return false;
}
#endregion 
