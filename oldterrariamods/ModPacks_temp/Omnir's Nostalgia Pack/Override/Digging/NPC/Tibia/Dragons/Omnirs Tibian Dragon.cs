...
public static bool SpawnNPC(int x, int y, int playerID) 
{
    ...
    {
        if (Main.bloodMoon && Main.rand.Next(90)==1) return true;
    	if (Main.player[playerID].townNPCs <= 0f)
        {
            if ((x < Main.maxTilesX*0.32f || x > Main.maxTilesX*0.68f) && Main.rand.Next(200)==1) return true;
            else if (Main.hardMode && Main.rand.Next(50)==1) return true;
    	    else if (oCavern && (x < Main.maxTilesX*0.32f || x > Main.maxTilesX*0.68f) && Main.rand.Next(75)==1) return true;
    	    else if ((oSurface || oUnderSurface || oUnderground || oCavern) && Main.rand.Next(300)==1) return true;
    	    return false;
        }
    }
    else if (Main.player[playerID].townNPCs <= 0f && Main.hardMode && Main.player[playerID].zoneEvil && Main.rand.Next(50)==1) return true;
    return false;
}
#endregion
...
public void NPCLoot()
{
    if (npc.life <= 0)
    {
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Dragon Gore 1", 1.1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Dragon Gore 2", 1.1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Dragon Gore 3", 1.1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Dragon Gore 2", 1.1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Dragon Gore 3", 1.1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Dragon Gore 4", 1.1f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Tibian Dragon Gore 5", 1.1f, -1);
    }
}
#endregion