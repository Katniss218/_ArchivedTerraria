...
public void AI()
{
    ...
    {
        Main.player[Main.myPlayer].AddBuff(31, 900, false);
    }
}
#endregion
...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
        ...
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width / 2), projectile.position.Y + (float)(projectile.height - 3), 3, 0, "Spell Effect Buff", 8, 3f, projectile.owner);
