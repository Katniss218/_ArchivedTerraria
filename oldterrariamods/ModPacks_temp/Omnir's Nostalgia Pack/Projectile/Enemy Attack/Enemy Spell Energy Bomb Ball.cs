...
public void Kill()
{
    ...
    projectile.timeLeft = 0;
    {
        ...
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*3), projectile.position.Y + (float)(projectile.height*3), 0, 0, "Enemy Spell Energy Bomb", 25, 5f, projectile.owner);
