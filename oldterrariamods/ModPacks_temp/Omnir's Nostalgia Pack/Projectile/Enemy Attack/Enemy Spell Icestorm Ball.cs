...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
        ...
        if (projectile.position.X + (float)(projectile.width / 2) > Main.player[projectile.owner].position.X + (float)(Main.player[projectile.owner].width / 2))
        {
            ...
            {
                if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60)-2)), ((Main.rand.Next(30))*-1), 0, "Enemy Spell Icestorm Icicle 1", 100, 3f, projectile.owner);
                if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60)-5)), ((Main.rand.Next(30))*-1), 0, "Enemy Spell Icestorm Icicle 2", 106, 4f, projectile.owner);
                if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60)-3)), ((Main.rand.Next(30))*-1), 0, "Enemy Spell Icestorm Icicle 3", 96, 3f, projectile.owner);
                if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60)-5)), ((Main.rand.Next(30))*-1), 0, "Enemy Spell Icestorm Icicle 4", 124, 5f, projectile.owner);
            }
...
/*          if (Main.rand.Next(4)==1)
        ...
        else
        {
		    if (Main.rand.Next(5)==1)
            {
                if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60)-2)), (Main.rand.Next(30)), 0, "Enemy Spell Icestorm Icicle 1", 100, 3f, projectile.owner);
                if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60)-5)), (Main.rand.Next(30)), 0, "Enemy Spell Icestorm Icicle 2", 106, 4f, projectile.owner);
                if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60)-3)), (Main.rand.Next(30)), 0, "Enemy Spell Icestorm Icicle 3", 96, 3f, projectile.owner);
                if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60)-5)), (Main.rand.Next(30)), 0, "Enemy Spell Icestorm Icicle 4", 124, 5f, projectile.owner);
            }
 		    if (Main.rand.Next(7)==1)
            {
                if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60)-2)), (Main.rand.Next(30)), 0, "Enemy Spell Icestorm Icicle 1", 100, 3f, projectile.owner);
