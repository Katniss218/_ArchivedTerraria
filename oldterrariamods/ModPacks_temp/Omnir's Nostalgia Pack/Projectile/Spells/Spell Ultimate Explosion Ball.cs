...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
        ...
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*+3f), projectile.position.Y + (float)(projectile.height*+5.5f), 0, 0, "Spell Ultimate Explosion", (int) ((80 + (Main.player[projectile.owner].statMana/10)) * (Main.player[projectile.owner].magicDamage)), 8f, projectile.owner);
