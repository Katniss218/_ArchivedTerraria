...
public void Kill()
{
    ...
    projectile.timeLeft = 0;
    {
        ...
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width-5), projectile.position.Y + (float)(projectile.height-5), 0, 0, "Spell Fireball", (int) ((32 + (Main.player[projectile.owner].statMana/20)) * Main.player[projectile.owner].magicDamage), 6f, projectile.owner);
