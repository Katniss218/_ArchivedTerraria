...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
        ...
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height), 0, 5, "Spell Ice 4 Icicle", (int) ((100 + (Main.player[projectile.owner].statManaMax2/10)) * (Main.player[projectile.owner].magicDamage)), 3f, projectile.owner);
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*5), projectile.position.Y + (float)(projectile.height*4), 0, 5, "Spell Ice 4 Icicle", (int) ((100 + (Main.player[projectile.owner].statManaMax2/10)) * (Main.player[projectile.owner].magicDamage)), 3f, projectile.owner);
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*-3), projectile.position.Y + (float)(projectile.height*7), 0, 5, "Spell Ice 4 Icicle", (int) ((100 + (Main.player[projectile.owner].statManaMax2/10)) * (Main.player[projectile.owner].magicDamage)), 3f, projectile.owner);
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height*10), 0, 5, "Spell Ice 4 Icicle", (int) ((100 + (Main.player[projectile.owner].statManaMax2/10)) * (Main.player[projectile.owner].magicDamage)), 3f, projectile.owner);				
