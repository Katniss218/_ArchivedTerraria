...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
		Main.PlaySound(2, (int)projectile.position.X, (int)projectile.position.Y, 10);
            if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width / 2), projectile.position.Y + (float)(projectile.height / 2), 0, 5, "Spell Ice 2 Icicle", (int) ((20 + (Main.player[projectile.owner].statManaMax2/10)) * (Main.player[projectile.owner].magicDamage)), 3f, projectile.owner);
            if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*2), projectile.position.Y + (float)(projectile.height), 0, 5, "Spell Ice 2 Icicle", (int) ((20 + (Main.player[projectile.owner].statManaMax2/10)) * (Main.player[projectile.owner].magicDamage)), 3f, projectile.owner);
