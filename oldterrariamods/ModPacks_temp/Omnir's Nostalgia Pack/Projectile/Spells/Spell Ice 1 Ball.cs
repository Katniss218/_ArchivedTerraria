...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
        ...
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width / 2), projectile.position.Y + (float)(projectile.height / 2), 0, 5, "Spell Ice 1 Icicle", (int) ((10 + (Main.player[projectile.owner].statManaMax2/10)) * (Main.player[projectile.owner].magicDamage)), 3f, projectile.owner);
