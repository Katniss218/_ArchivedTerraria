...
public void Kill()
{
    ...
    projectile.timeLeft = 0;
    {
        ...
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height), 0, 0, "Spell Fire Bomb", (int) ((20 + (Main.player[projectile.owner].statMana/10)) * Main.player[projectile.owner].magicDamage), 3f, projectile.owner);
