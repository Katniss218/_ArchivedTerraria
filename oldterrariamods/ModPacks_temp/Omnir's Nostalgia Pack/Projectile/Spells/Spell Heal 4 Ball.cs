...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
        ...
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(Main.mouseX + Main.screenPosition.X + (float)(projectile.width/2), Main.mouseY + Main.screenPosition.Y + (float)(projectile.height/2), 0, 0, "Spell Heal 4", 0, 0f, projectile.owner);
