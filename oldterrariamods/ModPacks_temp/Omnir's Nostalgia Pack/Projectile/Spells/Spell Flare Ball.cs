...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
        ...
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width/2), projectile.position.Y + (float)(projectile.height/2), 0, 0, "Spell Flare", (int) ((150 + (Main.player[projectile.owner].statMana/10)) * (Main.player[projectile.owner].magicDamage)), 3f, projectile.owner);
