...
public void Kill()
{
    ...
    projectile.timeLeft = 0;
    {
        ...
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*3), projectile.position.Y + (float)(projectile.height*3), 0, 0, "Spell Energy Bomb", (int) ((25 + (Main.player[projectile.owner].statMana/20)) * Main.player[projectile.owner].magicDamage), 5f, projectile.owner);
