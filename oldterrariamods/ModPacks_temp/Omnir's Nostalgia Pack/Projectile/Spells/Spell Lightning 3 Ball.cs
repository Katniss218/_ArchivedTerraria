...
public void Kill()
{
	...
	projectile.timeLeft = 0;
    {
        ...
        if(projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width / 2), projectile.position.Y + (float)(projectile.height / 2), 0, 0, "Spell Lightning 3 Bolt 1", (int) ((Main.player[projectile.owner].statMana/10) + this.projectile.damage), 8f, projectile.owner);
