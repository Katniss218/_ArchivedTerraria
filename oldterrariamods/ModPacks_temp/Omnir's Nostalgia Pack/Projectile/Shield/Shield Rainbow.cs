...
public void AI()
{
    ...
    if ((altLight >=1f) && (altLight < 2f))
    {
        Lighting.addLight(i2, j2, 2f, 0f, 0f);
        altLight += 0.2f;
    }
    else if ((altLight >=2f) && (altLight < 3f))
    {
        altLight += 0.2f;
        Lighting.addLight(i2, j2, 1f, 1f, 0f);
    }
    else if ((altLight >=3f) && (altLight < 4f))
    {
        Lighting.addLight(i2, j2, 0f, 2f, 0f);
        altLight += 0.2f;
    }
    else if ((altLight >=4f) && (altLight < 5f))
    {
        Lighting.addLight(i2, j2, 0f, 1f, 1f);
        altLight += 0.2f;
    }
    else if ((altLight >=5f) && (altLight < 6f))
    {
        Lighting.addLight(i2, j2, 0f, 0f, 2f);
        altLight += 0.2f;
    }
    else if ((altLight >=6f) && (altLight < 7f))
    {
        Lighting.addLight(i2, j2, 1f, 0f, 1f);
        altLight += 0.2f;
    }
    else if (altLight >= 7f)
    {
