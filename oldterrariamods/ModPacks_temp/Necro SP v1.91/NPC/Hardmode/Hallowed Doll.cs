...
public static bool SpawnNPC(int x, int y, int playerID)
{
	...
	if (Main.hardMode && undergroundHoly)
...
public void NPCLoot()
{
    if (npc.life <= 0)
    {
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Hallowed Doll Gore 1", 1.3f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Hallowed Doll Gore 2", 1.3f, -1);
