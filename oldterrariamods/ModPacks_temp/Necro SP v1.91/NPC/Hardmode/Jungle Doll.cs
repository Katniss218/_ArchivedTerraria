...
public static bool SpawnNPC(int x, int y, int playerID)
{
	...
	{
	if (Main.npc[num36].active && Main.npc[num36].type == Config.npcDefs.byName["Jungle Doll"].type)
	{
	return false;
	}
	}
...
public void NPCLoot()
{
    if (npc.life <= 0)
    {
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Jungle Doll Gore 1", 1.3f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Jungle Doll Gore 2", 1.3f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Jungle Doll Gore 3", 1.3f, -1);
        Gore.NewGore(npc.position, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), "Jungle Doll Gore 3", 1.3f, -1);
    }
}
#endregion