...
public void UseItemEffect(Player player, Rectangle rectangle)
{
	...
	int dust = Dust.NewDust(new Vector2((float) rectangle.X, (float) rectangle.Y), rectangle.Width, rectangle.Height, 0, (player.velocity.X), player.velocity.Y, 0, color, 1f);
