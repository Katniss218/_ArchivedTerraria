			...
			if (projectile.ai[0] == 0f)
			{
				...
				if (num63 == 0f)
				{
                    if (projectile.position.X + (float)(projectile.width / 2) > Main.player[projectile.owner].position.X + (float)(Main.player[projectile.owner].width / 2))
                    {
                        ...
                        {
                            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60))), ((Main.rand.Next(30))*-1), 0, Config.projectileID["Enemy Inferno Storm 1"], 30, 1f, projectile.owner);
                            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60))), ((Main.rand.Next(30))*-1), 0, Config.projectileID["Enemy Inferno Storm 2"], 33, 1f, projectile.owner);
                            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60))), ((Main.rand.Next(30))*-1), 0, Config.projectileID["Enemy Inferno Storm 3"], 28, 1f, projectile.owner);
                            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60))), ((Main.rand.Next(30))*-1), 0, Config.projectileID["Enemy Inferno Storm 4"], 42, 1f, projectile.owner);
                        }
