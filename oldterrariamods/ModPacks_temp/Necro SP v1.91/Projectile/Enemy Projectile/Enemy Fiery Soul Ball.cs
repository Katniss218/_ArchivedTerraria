...
public void Kill()
{
    ...
    projectile.timeLeft = 0;
    {
        ...
        for (int num40 = 0; num40 < 20; num40++)
        {
            ...
            {
                Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60))), ((Main.rand.Next(30))*-1), ((Main.rand.Next(30))*-1), Config.projectileID["Enemy Fiery Soul"], 70, 5f, projectile.owner);
                Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60))), ((Main.rand.Next(30))*-1), ((Main.rand.Next(30))*-1), Config.projectileID["Enemy Fiery Soul"], 70, 5f, projectile.owner);
                Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60))), ((Main.rand.Next(30))*-1), ((Main.rand.Next(30))*-1), Config.projectileID["Enemy Fiery Soul"], 70, 5f, projectile.owner);
                Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60))), (Main.rand.Next(30)), (Main.rand.Next(30)), Config.projectileID["Enemy Fiery Soul"], 70, 5f, projectile.owner);
                Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60))), (Main.rand.Next(30)), (Main.rand.Next(30)), Config.projectileID["Enemy Fiery Soul"], 70, 5f, projectile.owner);
                Projectile.NewProjectile(projectile.position.X + (float)(projectile.width*(Main.rand.Next(50))), projectile.position.Y + (float)(projectile.height*(Main.rand.Next(60))), (Main.rand.Next(30)), (Main.rand.Next(30)), Config.projectileID["Enemy Fiery Soul"], 70, 5f, projectile.owner);
            }
