...
public void Kill()
{
	...
	projectile.timeLeft = 60;
    {
		...
		{
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width / 2), projectile.position.Y + (float)(projectile.height / 2), 0, 0, Config.projectileID["Blood Pop"], 40, 8f, projectile.owner);
