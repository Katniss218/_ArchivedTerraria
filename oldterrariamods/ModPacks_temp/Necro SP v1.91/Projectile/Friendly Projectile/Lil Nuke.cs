public void AI()
{
    ...
    if (projectile.frame >= 13)
	{
        ...
        Projectile.NewProjectile(projectile.position.X + (float)((projectile.width / 2)+30), projectile.position.Y + (float)(projectile.height / 2), 0, 0, Config.projectileID["Lil Nuke Explosion"], 500, 8f, projectile.owner);
		return;
	}
	{
