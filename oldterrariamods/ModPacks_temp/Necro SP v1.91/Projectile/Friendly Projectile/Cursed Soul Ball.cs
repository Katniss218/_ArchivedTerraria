...
public void DamagePVP(ref int damage, Player enemyPlayer)
{
	if (Main.rand.Next(3) == 0)
	{
		enemyPlayer.AddBuff(39, 600, false);
	}
}

public void AI()
{
												if (projectile.type == Config.projDefs.byName["Cursed Soul Ball"].type)
												{
													int num44 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 75, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 150, default(Color), 3.5f);
													Main.dust[num44].noGravity = true;
													Main.dust[num44].velocity *= 1.4f;
													num44 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 75, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 150, default(Color), 1.5f);
												}
												else
												{
													if (projectile.type == 79)
													{
														...
														{
															int num46 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 66, 0f, 0f, 100, new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB), 2.5f);
													...
													else
													{
														...
														int num47 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 20, 0f, 0f, 100, default(Color), 2f);
