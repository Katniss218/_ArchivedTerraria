...
if(this.projectile.damage > 2){
   ...
   Projectile.NewProjectile(this.projectile.position.X, this.projectile.position.Y, this.projectile.velocity.X, this.projectile.velocity.Y+1, Config.projDefs.byName["Cthulhu Bomb"].type, this.projectile.damage/2, 0, myID)   ; 
   Projectile.NewProjectile(this.projectile.position.X, this.projectile.position.Y, -this.projectile.velocity.X, -this.projectile.velocity.Y, Config.projDefs.byName["Cthulhu Bomb"].type, this.projectile.damage/2, 0, myID)   ;                          
}
}
public void AI()
{
